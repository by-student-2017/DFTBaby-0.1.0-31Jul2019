...
compiler_kwds = {"extra_f90_compile_args": ['-fopenmp','-lgomp','-fexternal-blas','-lblas'],
...
#
# compiler_kwds = {"extra_f90_compile_args": ["-fopenmp -lgomp -fexternal-blas -openmp-report1 -openmp -mkl=parallel -I$(MKLROOT)/include -DPARALLEL_OMP -L$(MKLROOT)/lib/intel64 -lmkl_intel_ilp64 -lmkl_core -liomp5 -lmkl_intel_thread -lmkl_mc3 -lmkl_def -lpthread -lm"], "extra_link_args": ["-lgomp -openmp-report1 -openmp -mkl=parallel -I$(MKLROOT)/include -DPARALLEL_OMP -L$(MKLROOT)/lib/intel64 -lmkl_intel_ilp64 -lmkl_core -liomp5 -lmkl_intel_thread -lmkl_mc3 -lmkl_def -lpthread -lm "]}
##
