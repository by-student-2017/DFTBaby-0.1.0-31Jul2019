...
from DFTB.RepulsivePotential.RepulsivePotential import RepulsivePotential, read_repulsive_potential, dummy_reppot_module
...
"erfgau" => erf(R_AB/R_lr) - 2/(sqrt(pi)*R_lr)*R_AB*Exp(-1/3 (R_AB/R_lr)^2)
        ...
        if parameter_set == "homegrown":
            try:
                ...
                raise e
            try:
                reppot_tables.load_atompairs(atompairs, missing_reppots=self.missing_reppots)
            except ImportError as e:
...
if __name__ == "__main__":
    ...
    parser = utils.OptionParserFuncWrapper([DFTB2.__init__, DFTB2.runSCC, DFTB2.saveLocalizedOrbitals, MoldenExporter.export, CubeExporter.exportCubes, SolventCavity.__init__], usage)
